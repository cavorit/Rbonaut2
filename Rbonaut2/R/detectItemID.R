...
detectItemID <- function(Stimulus){
  ...
  if (!isMultiTarg & RW ==  -160   & AW == 220  & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL02")
  ...
  if (!isMultiTarg & RW ==  130    & AW == 190  & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL06")
  ...
  if (!isMultiTarg & RW ==  -150   & AW == 240  & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL11")
  ...
  if (!isMultiTarg & RW ==  70     & AW == 190  & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL19")
  if (!isMultiTarg & RW ==  10     & AW == -60  & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL20")
  if (!isMultiTarg & RW ==  -150   & AW == -190 & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL21")
  ...
  if (!isMultiTarg & RW ==  70     & AW == -200 & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL24")
  ...
  if (!isMultiTarg & RW ==  -130   & AW == 260  & HW == "FF" & vA == 2 & (abs(sL-50)<35) & (abs(sR-50)<35)) return("BL31")
